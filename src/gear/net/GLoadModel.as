package gear.net {
	 ...
	 * @version 20121108
	 */
	public final class GLoadModel extends EventDispatcher {
		...
		private function changeHandler(event : Event) : void {
			var count : int = 0;
			var speed : int = 0;
			for each (var data:GLoadData in _list) {
				count += data.percent;
		 ...
		 * @param data 加载数据
		 */
		public function add(data : GLoadData) : void {
			_list.push(data);
		 ...
		 * @param data 加载数据 
		 */
		public function remove(data : GLoadData) : void {
