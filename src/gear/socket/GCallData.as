package gear.socket {
	...
	public class GCallData {
		 ...
		 */
		public function GCallData(method : String, args : Array) {
			_method = method;
			_args = args;
		}
		 ...
		 * 
		 */
		public static function parse(value : Object) : GCallData {
			if (value == null) {
			...
			if (value.hasOwnProperty("method")) {
				...
				var data : GCallData = new GCallData(value.method, value.args);
				return data;
			} else {
